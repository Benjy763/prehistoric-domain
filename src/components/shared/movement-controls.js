...
module.exports = AFRAME.registerComponent('custom-movement-controls', {
  /*******************************************************************
   * Schema
   */
  ...
  schema: {
    ...
    blockMovement: { default: false } // New flag to block movement
  },
  ...
  update: function (prevData) {
    ...
    if (!data.enabled && data.blockMovement) {
      console.warn(
        '[movement-controls] Movement is blocked and controls are disabled.'
      );
    }
  },
  ...
  tick: (function () {
    ...
    return function (t, dt) {
      ...
      if (!velocityCtrl || data.blockMovement) {
        // Skip movement updates if blockMovement is true
        return;
      }
